...
var _api_util = __webpack_require__(61);
...
var _book_actions = __webpack_require__(23);
...
var _books_reducer = __webpack_require__(60);

var _books_reducer2 = _interopRequireDefault(_books_reducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _redux.combineReducers)({
  books: _books_reducer2.default
});
...
var booksReducer = function booksReducer() {
  ...
  switch (action.type) {
    case _book_actions.RECEIVE_SEARCH_RESULTS:
      return action.books;
    default:
      return oldState;
  }
...
var fetchSearchBooks = exports.fetchSearchBooks = function fetchSearchBooks(query) {
  return axios.get('https://www.googleapis.com/books/v1/volumes?q=f' + query + '&key=' + gbooksApiKey).then(function (response) {
...
var _book_search_container = __webpack_require__(77);

var _book_search_container2 = _interopRequireDefault(_book_search_container);
...
var Root = function Root(_ref) {
  ...
  return _react2.default.createElement(
    ...
    { store: store },
    _react2.default.createElement(_book_search_container2.default, null)
  );
};
...
var _book_search = __webpack_require__(78);

var _book_search2 = _interopRequireDefault(_book_search);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchBooks: function fetchSearchBooks(query) {
      return dispatch((0, _book_actions.fetchSearchBooks)(query));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_book_search2.default);
...
var _book_index = __webpack_require__(79);

var _book_index2 = _interopRequireDefault(_book_index);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('div', { id: 'filter_place_holder' }),
          _react2.default.createElement(_book_index2.default, { books: books })
        )
      );
    }
  }]);
...
var _book_index_item = __webpack_require__(80);

var _book_index_item2 = _interopRequireDefault(_book_index_item);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function BookIndex(_ref) {
  ...
  return _react2.default.createElement(
    ...
    books.map(function (book) {
      return _react2.default.createElement(_book_index_item2.default, { key: book.id, book: book });
    })
  );
}
...
function BookIndexItem(_ref) {
  var book = _ref.book;

  return _react2.default.createElement(
    "li",
    { className: "book_index_item" },
    _react2.default.createElement("img", { src: book.volumeInfo.imageLinks.thumbnail, className: "book_cover" }),
    _react2.default.createElement(
      "div",
      { className: "book_info" },
      _react2.default.createElement(
